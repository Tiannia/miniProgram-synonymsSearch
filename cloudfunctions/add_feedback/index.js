...
exports.main = async (event, context) => {
    ...
    try {
        var mes_result = await sendSubscribeMessage(openid, username, content, time)
    } catch (e) {
 ...
 * @param {*} time 
 */
async function sendSubscribeMessage(openid, username, content, time) {
    // 用户的openid
    const OPENID = openid
    // 消息模板
    const templateId = 'wWIPy_EkgiMPaoOs8gk6AdLdyQy632TVoWoROR3UfBY'
    // 调用发送函数
